...
_Laravel Shift_ focuses on providing automated and [human services](https://laravelshift.com/human-services) for upgrading and improving your Laravel applications.

Shifts for _Laravel_ include:
...
- [Mysqli Shift - covert mysql to mysqli](https://laravelshift.com/upgrade-mysql-mysqli)
  aaaaaaaaaaaaaaaaaaaaaaaasdsadsa test test test
